// Borrowed from https://github.com/esprehn/tasklets
(function(global) {
...
class ServiceContext {
  ...
  get remote() { return this.remote_; }
  ...
  handleMessageEvent_(event) {
    ...
    switch (type) {
      case kDispatch:
        this.dispatch_(resolverId, instanceId, methodName, args, event);
        break;
      case kResolve:
  ...
  async dispatch_(resolverId, instanceId, methodName, args, event) {
    ...
    try {
      ...
      let result = await method.apply(entry.instance, [...args, event]);
